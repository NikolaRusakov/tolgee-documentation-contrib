...
- Install and initialize the SDK: [Installation](/android-sdk/integrations/android-views/installation)
- Use translations in Views and handle plurals/parameters: [Usage](/android-sdk/integrations/android-views/translating)
- Use localized composables: [Jetpack Compose](/android-sdk/integrations/jetpack-compose/installation)

In production, configure content delivery (CDN) using the Android [Installation](/android-sdk/integrations/android-views/installation) and [Production guide](/android-sdk/production), and preload data as needed.
