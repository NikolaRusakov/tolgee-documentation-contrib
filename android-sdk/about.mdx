...
The [guides for AI agents](./agents/index.mdx) are task-shaped recipes (install, migrate resource strings, diagnose)
with a copy-paste prompt that lets Claude Code, Cursor, Copilot or Codex integrate the SDK for you. Machine-readable
entry points: [`docs.tolgee.io/llms.txt`](https://docs.tolgee.io/llms.txt) for these docs (append `.md` to any page
URL for its Markdown twin) and
[`tolgee.github.io/tolgee-mobile-kotlin-sdk/llms.txt`](https://tolgee.github.io/tolgee-mobile-kotlin-sdk/llms.txt)
for the API reference generated from KDoc.
